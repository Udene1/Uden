...
const styles = StyleSheet.create({
  ...
  authTabs: { height: 42, borderRadius: 12, padding: 3, backgroundColor: COLORS.surface2, flexDirection: 'row', borderWidth: 1, borderColor: COLORS.border },
  authTab: { flex: 1, borderRadius: 9, alignItems: 'center', justifyContent: 'center' },
  authTabActive: { backgroundColor: COLORS.elevated, borderWidth: 1, borderColor: COLORS.border },
  authTabText: { color: COLORS.muted, fontSize: 11, fontWeight: '700' },
  authTabTextActive: { color: COLORS.text },
  advancedLink: { color: COLORS.muted, textAlign: 'center', fontSize: 11, paddingVertical: 4 },
