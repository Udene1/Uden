...
export default function Header() {
  ...
  return (
    <>
      <header className="z-10 m-2 flex h-14 shrink-0 items-center justify-between rounded-xl border bg-[var(--bg-secondary)] px-3 md:m-4 md:h-16 md:px-5" style={{ borderColor: 'var(--border-color)' }}>
        <div className="flex min-w-0 items-center gap-2.5 md:gap-3">
          <div className="hidden h-8 w-8 items-center justify-center rounded-lg border bg-[var(--bg-tertiary)] text-[var(--text-muted)] sm:flex" style={{ borderColor: 'var(--border-color)' }}><Command size={15} /></div>
