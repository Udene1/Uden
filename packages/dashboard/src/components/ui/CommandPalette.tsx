...
export default function CommandPalette() {
  ...
  const filtered = useMemo(() => {
    ...
    return q ? actions.filter(a => `${a.label} ${a.hint} ${a.keys}`.toLowerCase().includes(q)) : actions;
  }, [query]);
