...
import type { CodeSourceProvider, CodeRepositoryRef } from './code-source';

export type RepositoryOperationType = 'create_branch' | 'commit_files' | 'create_pull_request' | 'merge_pull_request';
